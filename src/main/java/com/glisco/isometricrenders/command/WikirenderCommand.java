...
public class WikirenderCommand {
    ...
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher, CommandRegistryAccess access) {
        dispatcher.register(literal("wikirender")
                .executes(WikirenderCommand::showRootNodeHelp)
                .then(literal("area")
                        .executes(WikirenderCommand::renderAreaSelection)
                        .then(argument("start", BlockPosArgumentType.blockPos())
                                .then(argument("end", BlockPosArgumentType.blockPos())
                                        .executes(WikirenderCommand::renderAreaWithArguments))))
                .then(literal("block")
                        .executes(WikirenderCommand::renderTargetedBlock)
                        .then(argument("block", BlockStateArgumentType.blockState(access))
                                .executes(WikirenderCommand::renderBlockWithArgument)))
                .then(literal("entity")
                        .executes(WikirenderCommand::renderTargetedEntity)
                        .then(argument("entity", RegistryEntryReferenceArgumentType.registryEntry(access, RegistryKeys.ENTITY_TYPE))
                                ...
                                .executes(WikirenderCommand::renderEntityWithoutNbt)
                                .then(argument("nbt", NbtCompoundArgumentType.nbtCompound())
                                        .executes(WikirenderCommand::renderEntityWithNbt))))
                .then(literal("player")
                        .executes(WikirenderCommand::renderSelf)
                        .then(argument("player", StringArgumentType.string())
                                .executes(WikirenderCommand::renderPlayerWithoutNbt)
                                .then(argument("nbt", NbtCompoundArgumentType.nbtCompound())
                                        .executes(WikirenderCommand::renderPlayerWithNbt))))
                .then(literal("item")
                        .executes(WikirenderCommand::renderHeldItem)
                        .then(argument("item", ItemStackArgumentType.itemStack(access))
                                .executes(WikirenderCommand::renderItemWithArgument)))
                .then(literal("tooltip")
                        .executes(WikirenderCommand::renderHeldItemTooltip)
                        .then(argument("item", ItemStackArgumentType.itemStack(access))
                                .executes(WikirenderCommand::renderItemTooltipWithArgument)))
                .then(literal("namespace")
                        .then(argument("namespace", NamespaceArgumentType.namespace())
                                .then(argument("task", new RenderTaskArgumentType())
                                        .executes(WikirenderCommand::renderNamespace))))
                .then(literal("creative_tab")
                        .then(argument("itemgroup", ItemGroupArgumentType.itemGroup())
                                .then(argument("task", new RenderTaskArgumentType())
                                        .executes(WikirenderCommand::renderCreativeTab))))
                .then(literal("tag")
                        .then(argument("tag", new TagArgumentType(access))
                                .then(argument("task", new RenderTaskArgumentType())
                                        .executes(WikirenderCommand::renderTagContents))))
                .then(literal("unsafe")
                        .then(literal("enable")
                                .executes(WikirenderCommand::enableUnsafe))
                        .then(literal("disable")
                                .executes(WikirenderCommand::disableUnsafe))));
    }
